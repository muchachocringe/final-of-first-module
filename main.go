...
func (t Training) meanSpeed() float64 {
	...
	a := t.distance()
	return float64(a) / t.Duration.Hours()
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*float64(w.Weight) + ((w.meanSpeed()*w.meanSpeed())/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * float64(MinInHours))
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	//LengthPool * CountPool / MInKm / Duration
	if s.Duration == 0 {
		return 0
	}
